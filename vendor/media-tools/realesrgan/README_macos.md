...
If you encounter the problem that _macOS cannot verify that this app is free from Malware_, you have two options to try:

1. Choose _Apple menu_ > go to _System Preferences_ > choose _Security & Privacy_ > tap the General tab > click the _Open Anyway_ button.
