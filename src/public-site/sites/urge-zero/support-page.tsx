...
export const metadata: Metadata = {
  ...
  description:
    "Get help with Urge Zero, including contact details, FAQs, and troubleshooting guidance.",
};

const faqs = [
  {
    question: "How do I handle a strong urge right now?",
    answer:
      "Open Urge Zero and start an emergency or recovery flow from the home screen. Follow the guided steps until the urge intensity drops, then log the event in your history.",
  },
  {
    question: "How do I track streaks and relapse history?",
    answer:
      "Your streak, urge battles, and relapse records are available in the progress/history area of the app. You can review patterns over time and monitor consistency.",
  },
  {
    question: "Can I block triggering apps or websites?",
    answer:
      "Yes. Urge Zero supports blocker and protection features (depending on your platform and permissions). Enable them in settings and grant the required system access.",
  },
  {
    question: "What should I do if I relapsed?",
    answer:
      "Log the relapse, review the trigger, and restart your recovery plan immediately. A reset is part of the process, and consistent follow-up actions matter more than one setback.",
  },
  {
  ...
  {
    question: "Can I request a new recovery feature?",
    answer:
      ...
      <article className="w-full max-w-3xl rounded-xl bg-white p-6 shadow-sm sm:p-10">
        <header className="mb-10">
          ...
          <p className="leading-8 text-zinc-700">
            Need help with Urge Zero? This page includes support contact
            details, common questions, and troubleshooting guidance so you can
        ...
        <section className="mb-10">
          ...
          <p className="leading-8 text-zinc-700">
            Have an idea to improve Urge Zero? Send your suggestion to{" "}
            <a
              href="mailto:support@anmisoft.com"
