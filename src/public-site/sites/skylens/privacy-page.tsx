...
export const metadata: Metadata = {
  ...
  description: "Privacy policy for the SkyLens app.",
};

export default function SkyLensPrivacyPage() {
  return (
    <main className="legal-document flex flex-1 justify-center bg-zinc-50 px-4 py-12 text-zinc-900">
      <article className="legal-document__article w-full max-w-3xl rounded-xl bg-white p-6 shadow-sm sm:p-10">
        ...
        <p className="mb-6 leading-8 text-zinc-700">
          ...
          collect, how we collect it, how we use it, when we share it, how long
          we keep it, and how you can manage your choices. Where required,
          SkyLens asks for your permission before sending your personal data to
        ...
        <section className="mb-8">
          ...
          <p className="mb-3 leading-8 text-zinc-700">
            Depending on how you use SkyLens, we may collect the following
            information:
          </p>
          <ul className="list-disc space-y-2 pl-6 leading-8 text-zinc-700">
            <li>
              ...
              upload from your photo library. These images may contain objects,
              locations, documents, faces, or other personal visual information.
            </li>
            <li>
            ...
            <li>
              AI-generated responses, visual analysis results, saved results,
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc space-y-2 pl-6 leading-8 text-zinc-700">
            ...
            <li>
              Automatically from your use of SkyLens, including app usage,
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc space-y-2 pl-6 leading-8 text-zinc-700">
            <li>
              Identify objects and provide AI-powered answers based on content
              you submit.
            </li>
            <li>
              Generate photo analysis, topic responses, summaries, and follow-up
              replies that you request.
            </li>
            <li>
            ...
            <li>
              Operate, secure, troubleshoot, and improve SkyLens, including
        ...
        <section className="mb-8">
          ...
          <p className="mb-4 leading-8 text-zinc-700">
            SkyLens uses Google Gemini AI, operated by Google LLC, to identify
            objects, analyze photos, and answer questions. Before SkyLens sends
            your photos or questions to Google Gemini AI, the app asks for your
            in-app permission through the AI Processing Consent prompt.
          </p>
          <p className="mb-3 leading-8 text-zinc-700">
            When you choose AI processing, SkyLens may securely send the
            following data to Google Gemini AI:
          </p>
          <ul className="mb-4 list-disc space-y-2 pl-6 leading-8 text-zinc-700">
            ...
            <li>
              ...
              preference, selected analysis mode, and similar app settings for
              that request.
            </li>
          </ul>
          <p className="leading-8 text-zinc-700">
            This data is shared with Google Gemini AI only to generate the
            identification, answer, analysis, topic response, or follow-up
            response you request. Google may process this data under
        ...
        <section className="mb-8">
          ...
          <p className="mb-3 leading-8 text-zinc-700">
            ...
            improve SkyLens. The third parties that may receive user data
            include:
          </p>
          <ul className="list-disc space-y-2 pl-6 leading-8 text-zinc-700">
            <li>
            ...
            <li>
              Google Analytics: receives usage and performance data to help us
              understand app and website behavior and improve reliability and
              functionality.
            </li>
            <li>
              Cloud hosting, authentication, database, storage, and server
              providers: process data needed to run SkyLens features, store user
        ...
        <section className="mb-8">
          ...
          <p className="mb-3 leading-8 text-zinc-700">
            SkyLens asks for your permission before sending photos, images,
            questions, prompts, or follow-up messages to Google Gemini AI. You
            can choose:
          </p>
          <ul className="list-disc space-y-2 pl-6 leading-8 text-zinc-700">
            <li>
              Agree &amp; Continue: SkyLens saves your AI Processing Consent on
              your device and sends the selected request for AI processing.
            </li>
            <li>
              Not now: SkyLens does not send that request to Google Gemini AI,
              and you will be asked again before a future AI processing request.
            </li>
          </ul>
          <p className="mt-4 leading-8 text-zinc-700">
            You can revoke AI Processing Consent in the app at Settings &gt;
            Legal &gt; AI Processing Consent. After revocation, SkyLens will ask
        ...
        <section className="mb-8">
          ...
          <p className="mb-4 leading-8 text-zinc-700">
            ...
            SkyLens features, maintain your account, comply with legal
            obligations, resolve disputes, enforce our terms, prevent abuse, and
            maintain security.
          </p>
          <ul className="list-disc space-y-2 pl-6 leading-8 text-zinc-700">
            <li>
