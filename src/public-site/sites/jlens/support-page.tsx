...
export function JlensSupportPage({ locale }: { locale: SupportedLocaleCode }) {
        ...
        content: (
          <p>
            {t.rich("support.deletionBody", {
              email: (chunks) => (
                <a href="mailto:support@anmisoft.com?subject=JLens%20deletion%20request">
                  {chunks}
                </a>
              ),
              privacy: (chunks) => (
        ...
        content: (
          <p>
            {t.rich("support.featureBody", {
              email: (chunks) => (
                <a href="mailto:support@anmisoft.com?subject=JLens%20feature%20request">
                  {chunks}
                </a>
              ),
            })}
...
export default function JewelryIdentifierSupportPage() {
  return <JlensSupportPage locale={defaultLocale} />;
}
