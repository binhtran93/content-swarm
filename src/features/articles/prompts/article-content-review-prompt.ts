...
Keep proposals small enough to review independently. Preserve valid links and approved MDX components. Do not return ratings, explanations, summaries, categories, or general feedback. If no meaningful changes are needed, return an empty changes array. Return only the requested structured result.`,
};
